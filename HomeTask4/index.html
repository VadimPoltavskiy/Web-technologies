...
$experience = [
			'date' => ['Январь 2015', 'март 2012 - декабрь 2014','июнь 2010 - март 2012'],
            'post' => ['Front End разработчик','Веб-разработчик / something.com','Графический дизайнер / designsomething.com'],
            'description' => ['Разработка и оптимизация алгоритмов','Подержка работы сайта (обновление и оптимизация сайта)','Разработка логотипов, эмблем, для заказчиков']
			  ]
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['post'][0]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][0]?> - <span class="w3-tag w3-teal w3-round"> Current</span></h6>
          <p><?php echo $experience['description'][0]?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['post'][1]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][1]?></h6>
          <p><?php echo $experience['description'][1]?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['post'][1]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][2]?></h6>
...
</html>%"><?php echo $skills['level'][0]; ?>%</div>
          </div>
          <p><?php echo $skills['skill_name'][1]; ?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skills['level'][1]; ?>%">
